...
import br.com.luizjoaquim.cursomc.domain.ItemPedido;
...
import br.com.luizjoaquim.cursomc.repositories.ItemPedidoRepository;
...
//CommandLineRunner  executa o metodo run antes de subir a aplicação
	...
	@Autowired
	private ItemPedidoRepository itemPedidoRepositoryo;
	...
	public void run(String... args) throws Exception {
		...
		itemPedidoRepositoryo.saveAll(Arrays.asList(ip1,ip2,ip3));
	}
